...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b866610d90f11a271f5ae1a4a3cd3938e859a77bf0505f233fcccb6a941b3163.js',function(){input.required=false;search();});}
